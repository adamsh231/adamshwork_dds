                    ...
                    <div class="blog-details-content">
                        ...
                        <div class="post-details-text">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12">
                                    <img class="mb-50" src="<?php echo base_url()?>uza/img/bg-img/14.jpg" alt="">
                                </div>
                                <div class="col-12 col-lg-10">
                                        ...
                                        <ol>
                                            ...
                                            <li class="single_comment_area">
                                                ...
                                                <div class="comment-content d-flex">
                                                    ...
                                                    <div class="comment-author">
                                                        <img src="<?php echo base_url()?>uza/img/bg-img/15.jpg" alt="author">
                                                    </div>
                                                    <!-- Comment Meta -->
                                                ...
                                                <ol class="children">
                                                    <li class="single_comment_area">
                                                        ...
                                                        <div class="comment-content d-flex">
                                                            <!-- Comment Author -->
                                                            <div class="comment-author">
                                                                <img src="<?php echo base_url()?>uza/img/bg-img/16.jpg" alt="author">
                                                            </div>
                                                            <!-- Comment Meta -->
                                                            <div class="comment-meta">
                                                                <a href="#" class="post-date">27 Aug 2018</a>
                                            ...
                                            <li class="single_comment_area">
                                                ...
                                                <div class="comment-content d-flex">
                                                    <!-- Comment Author -->
                                                    <div class="comment-author">
                                                        <img src="<?php echo base_url()?>uza/img/bg-img/17.jpg" alt="author">
                                                    </div>
                                                    <!-- Comment Meta -->
                                                    <div class="comment-meta">
                                                        <a href="#" class="post-date">27 Aug 2018</a>
