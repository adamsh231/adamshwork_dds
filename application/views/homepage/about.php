    ...
    <div class="breadcrumb-area">
        ...
        <div class="breadcrumb-bg-curve">
            <img src="<?php echo base_url()?>uza/img/core-img/curve-5.png" alt="">
        </div>
    </div>
    <!-- ***** Breadcrumb Area End ***** -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-us-thumbnail mb-80">
                        <img src="<?php echo base_url()?>uza/img/bg-img/2.jpg" alt="">
                        <!-- Video Area -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="choose-us-thumbnail mb-80">
                        <img class="w-100" src="<?php echo base_url()?>uza/img/bg-img/22.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="team-sildes owl-carousel">
                    ...
                    <div class="single-team-slide">
                        <img src="<?php echo base_url()?>uza/img/bg-img/18.jpg" alt="">
                        <!-- Overlay Effect -->
                    ...
                    <!-- Single Team Slide -->
                    <div class="single-team-slide">
                        <img src="<?php echo base_url()?>uza/img/bg-img/19.jpg" alt="">
                        <!-- Overlay Effect -->
                        <div class="overlay-effect">
                            <h6>DESIGNER</h6>
                            <h4>Roger Black</h4>
                    ...
                    <!-- Single Team Slide -->
                    <div class="single-team-slide">
                        <img src="<?php echo base_url()?>uza/img/bg-img/20.jpg" alt="">
                        <!-- Overlay Effect -->
                        <div class="overlay-effect">
                            <h6>DESIGNER</h6>
                            <h4>Roger Black</h4>
                    ...
                    <!-- Single Team Slide -->
                    <div class="single-team-slide">
                        <img src="<?php echo base_url()?>uza/img/bg-img/21.jpg" alt="">
                        <!-- Overlay Effect -->
                        <div class="overlay-effect">
                            <h6>DESIGNER</h6>
                            <h4>Roger Black</h4>
                    ...
                    <div class="testimonial-slides owl-carousel">
                        ...
                        <div class="single-testimonial-slide d-flex align-items-center">
                            ...
                            <div class="testimonial-thumbnail">
                                <img src="<?php echo base_url()?>uza/img/bg-img/7.jpg" alt="">
                            </div>
                            <!-- Testimonial Content -->
                            <div class="testimonial-content">
                                ...
                                <!-- Quote Icon -->
                                <div class="quote-icon"><img src="<?php echo base_url()?>uza/img/core-img/quote.png" alt=""></div>
                            </div>
                        </div>
                        ...
                        <div class="single-testimonial-slide d-flex align-items-center">
                            <!-- Testimonial Thumbnail -->
                            <div class="testimonial-thumbnail">
                                <img src="<?php echo base_url()?>uza/img/bg-img/23.jpg" alt="">
                            </div>
                            <!-- Testimonial Content -->
                            <div class="testimonial-content">
                                <h4>“Colorlib Ltd’s ranking has gone up so much from the great work that your team has done and our brand get organic sales consistently from your efforts. We are happy that the results of your efforts were lasting and profitable.”</h4>
                        ...
                        <div class="single-testimonial-slide d-flex align-items-center">
                            <!-- Testimonial Thumbnail -->
                            <div class="testimonial-thumbnail">
                                <img src="<?php echo base_url()?>uza/img/bg-img/24.jpg" alt="">
                            </div>
                            <!-- Testimonial Content -->
                            <div class="testimonial-content">
                                <h4>“Colorlib Ltd’s ranking has gone up so much from the great work that your team has done and our brand get organic sales consistently from your efforts. We are happy that the results of your efforts were lasting and profitable.”</h4>
