    ...
    <?php if (isset($_SESSION['id_anak'])) {
        foreach ($anak as $a) { ?>
            ...
            <?php if(isset($_SESSION['tambah'])){echo $_SESSION['tambah'];}?>
                ...
                <div class="card-footer py-3 flex-row align-items-center justify-content-between">
                    <a href="<?php echo base_url() ?>index.php/DDS/index/tambahriwayat" style="float:right" class="btn btn-sm btn-info btn-icon-split"><span class="icon text-white"><i class="fas fa-user-clock"></i></span><span class="text">Update</span></a>
                </div>
            </div>
        </div>
    <?php } else { ?>
