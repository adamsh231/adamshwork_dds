...
<script>
    ...
    var umur = [];
    getJSON('https://dds.adamshwork.com/index.php/DDS_Json/autoValue/', function(err, data) {
        if (err !== null) {
    ...
    function lakukanJson(usia) {
        getJSON('https://dds.adamshwork.com/index.php/DDS_Json/autoValue/' + usia, function(err, data) {
            if (err !== null) {
                alert('Something went wrong: ' + err);
            } else {
                var umur = "";
