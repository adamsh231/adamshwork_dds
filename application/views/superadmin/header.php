    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item <?php if($title == "home") echo "active"?>">
        <a onclick="toogle()" class="nav-link" href="<?php echo base_url()?>index.php/DDS/index/home">
          ...
          <span>Daftar Anak</span></a>
      </li>
      
      <!-- Nav Item - new -->
      <li class="nav-item <?php if($title == "daftarkader" || $title == "tambahkader") echo "active"?>">
        <a onclick="toogle()" class="nav-link" href="<?php echo base_url()?>index.php/DDS/index/daftarkader">
          <i class="fas fa-fw fa-database"></i>
          <span>Daftar Kader</span></a>
      </li>

      <!-- Nav Item - new -->
      <li class="nav-item <?php if($title == "daftarposyandu" || $title == "tambahposyandu") echo "active"?>">
        <a onclick="toogle()" class="nav-link" href="<?php echo base_url()?>index.php/DDS/index/daftarposyandu">
          <i class="fas fa-fw fa-clinic-medical"></i>
          <span>Daftar Posyandu</span></a>
      </li>
      ...
      <!-- <li class="nav-item <?php if($title == "tambahriwayat") echo "active"?>">
        <a class="nav-link" href="<?php echo base_url()?>index.php/DDS/index/tambahriwayat">
          <i class="fas fa-fw fa-address-card"></i>
          <span>Tambah Riwayat Anak</span></a>
      </li> -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" onclick="alertx(2)" href="<?php echo base_url() ?>index.php/DDS/index/superadmin">Petunjuk Aplikasi</a>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
              ...
              <a class="nav-link">
                <div class="btn btn-icon-split btn-sm">
                  <div class="form-group">
                    <select onchange="window.location.href=this.value" class="form-control" id="posyandu">
                    <option value="<?php echo base_url()?>index.php/DDS_Auth/pilihPosyandu/-1/<?php echo $title?>" selected><span class="text h5">Semua Posyandu</span></option>
                      <?php foreach($pos as $p){?>
                        <option value="<?php echo base_url()?>index.php/DDS_Auth/pilihPosyandu/<?php echo $p['id']?>/<?php echo $title?>" <?php if($p['id'] == $_SESSION['id_pos']){ echo 'selected';}?>><span class="text h5">Posyandu <?php echo ucwords($p['nama'])?></span></option>
                      <?php }?>
                    </select>
                  </div>
                </div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item buka">
              <a class="nav-link" href="#" data-toggle="modal" data-target="#laporan">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item tutup" href="#" data-toggle="modal" data-target="#laporan">
