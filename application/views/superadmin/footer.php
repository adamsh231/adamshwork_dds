    ...
    <div class="modal fade" id="laporan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="exampleModalLabel">Download Laporan Tahun</h5>
                ...
                <br>
                <div class="container">
                    <form id="frm" action="<?php echo base_url()?>index.php/DDS_Excel" method="post">
                        <div class="form-group">
                            <input value="<?php echo date('Y')?>" type="number" class="form-control" id="tahun" name="tahun"  placeholder="Laporan Tahun" min="2015" max="<?php echo date('Y')?>"  required>
                        </div>
    ...
    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo base_url()?>index.php/DDS_Insert/deleteAdmin" method="post">
