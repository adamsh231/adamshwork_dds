...
<body onload="toogle()" id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - new -->
      <li class="nav-item <?php if ($title == "daftaranak") echo "active" ?>">
        <a onclick="toogle()" class="nav-link" href="<?php echo base_url() ?>index.php/DDS/index/daftaranak">
          <i class="fas fa-fw fa-child"></i>
          <span>Daftar Anak</span></a>
      </li>

      <!-- Nav Item - new -->
      <!-- <li class="nav-item <?php if ($title == "tambahanak") echo "active" ?>">
        <a class="nav-link" href="<?php echo base_url() ?>index.php/DDS/index/tambahanak">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" onclick="alertx(2)" href="<?php echo base_url() ?>index.php/DDS/index/user">Petunjuk Aplikasi</a>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <!-- Nav Item - Alerts -->
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url() ?>index.php/DDS/index/rekomendasi">
                <!-- onclick="alertx(1)" -->
                <div class="btn btn-outline-warning btn-icon-split btn-sm">
                  <i style="color:#white" class="fas fa-bell fa-fw"></i>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $dataIbu['nama'] ?></span>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <!-- <a class="dropdown-item tutup" onclick="alertx(1)" href="#">
