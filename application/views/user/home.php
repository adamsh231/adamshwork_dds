...
<script>
  ...
  getJSON('https://dds.adamshwork.com/index.php/DDS_Json/autoValueBB/' + jk, function(err, data) {
    if (err !== null) {
      ...
      getJSON('https://dds.adamshwork.com/index.php/DDS_Json/getRecord/', function(err2, data2) {
        if (err2 !== null) {
