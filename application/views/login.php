							...
							<div class="col-lg-6">
								...
								<div class="p-5">
									...
									<form class="user" action="<?php echo base_url() ?>index.php/auth" method="post">
										...
										<input name="inputEmail" type="hidden" id="username">
										<input name="inputPass" type="hidden" id="password">

										<button class="btn btn-info btn-user btn-block" onclick="login(1)" type="submit" name="submit">
											Login as Superadmin
										</button>
										<button class="btn btn-warning btn-user btn-block" onclick="login(2)" type="submit" name="submit">
											Login as Admin
										</button>
										<button class="btn btn-success btn-user btn-block" onclick="login(3)" type="submit" name="submit">
											Login as User
										</button>
